      ...
      1: [
        function (e, t, r) {
          (function (r, n) {
            ...
            function y(e, t, r) {
              p("sendPacket :: packet: %O", t),
                p("sendPacket :: emitting `packetsend`"),
                e.emit("packetsend", t),
                p("sendPacket :: writing to stream");
              var n = s.writeToStream(t, e.stream, e.options);
              p("sendPacket :: writeToStream result %s", n),
                !n && r
                  ? (p(
                      "sendPacket :: handle events on `drain` once through callback."
                    ),
                    e.stream.once("drain", r))
                  : r && (p("sendPacket :: invoking cb"), r());
            }
            function _(e, t, r, n) {
              p(
            ...
            function w(e, t) {
              ...
              for (r in ((this.options = t || {}), g))
                void 0 === this.options[r]
                  ? (this.options[r] = g[r])
                  : (this.options[r] = t[r]);
              p("MqttClient :: options.protocol", t.protocol),
                p("MqttClient :: options.protocolVersion", t.protocolVersion),
                p("MqttClient :: options.username", t.username),
                p("MqttClient :: options.keepalive", t.keepalive),
                p("MqttClient :: options.reconnectPeriod", t.reconnectPeriod),
                p(
                ...
                p("MqttClient :: clientId", this.options.clientId),
                ...
                this.on("connect", function () {
                  ...
                  p("connect :: sending queued packets"),
                    (function t() {
                      ...
                      r &&
                        ((i = r.packet),
                        p("deliver :: call _sendPacket for %o", i),
                ...
                this.on("close", function () {
                  p("close :: connected set to `false`"),
                    (this.connected = !1),
                    p("close :: clearing connackTimer"),
                    clearTimeout(this.connackTimer),
                    p("close :: clearing ping timer"),
                    null !== n.pingTimer &&
                      (n.pingTimer.clear(), (n.pingTimer = null)),
                    p("close :: calling _setupReconnect"),
                    this._setupReconnect();
                }),
                i.call(this),
                p("MqttClient :: setting up stream"),
                this._setupStream();
            }
            c(w, i),
              (w.prototype._setupStream = function () {
                var e,
                  t = this,
                  r = new a(),
                ...
                function u() {
                  ...
                  var e = o.shift();
                  if (e)
                    p("work :: packet pulled from queue"),
                      t._handlePacket(e, c);
                  else {
                ...
                if (
                  (p("_setupStream :: calling method to clear reconnect"),
                  ...
                  (r._write = function (e, t, r) {
                    (i = r),
                      p("writable stream :: parsing buffer"),
                      n.parse(e),
                      u();
                  }),
                  p("_setupStream :: pipe stream to writable stream"),
                  this.stream.pipe(r),
                  this.stream.on("error", function (e) {
                    p("streamErrorHandler :: error", e.message),
                      b.includes(e.code)
                        ? (p("streamErrorHandler :: emitting error"),
                          t.emit("error", e))
                        : v(e);
                  }),
                  this.stream.on("close", function () {
                    var e;
                    p("(%s)stream :: on close", t.options.clientId),
                      (e = t.outgoing) &&
                        (p(
                      ...
                      p("stream: emit close to MqttClient"),
                      t.emit("close");
                  }),
              ...
              (w.prototype._handlePacket = function (e, t) {
                ...
                switch (
                  (p("_handlePacket :: emitting packetreceive"),
              ...
              (w.prototype.publish = function (e, t, r, n) {
                ...
                switch (
                  ...
                  case 1:
                  case 2:
                    (this.outgoing[i.messageId] = { volatile: !1, cb: n || v }),
                      this._storeProcessing
                        ? (p("_storeProcessing enabled"),
                          (this._packetIdsDuringStoreProcessing[
                            i.messageId
                          ] = !1),
                          this._storePacket(i, void 0, r.cbStorePut))
                        : (p("MqttClient:publish: packet cmd: %s", i.cmd),
              ...
              (w.prototype.subscribe = function () {
                ...
                var g = { qos: 0 };
                if (
                  (5 === h && ((g.nl = !1), (g.rap = !1), (g.rh = 0)),
                  (c = f(g, c)),
                  Array.isArray(o)
                    ? o.forEach(function (e) {
                        if (
                          (p("subscribe: array topic %s", e),
                    ...
                    : Object.keys(o).forEach(function (e) {
                        if (
                          ...
                          5 === h &&
                            ...
                            (t.rh = o[e].rh),
                            (t.properties = c.properties)),
                            p("subscribe: pushing `%s` to subs list", t),
                            i.push(t);
                        }
                      }),
                  (e = {
                ...
                return (
                  ...
                  this._checkDisconnecting(o)
                    ...
                    : ("string" == typeof i
                      ...
                      p("unsubscribe: call _sendPacket"),
                      this._sendPacket(e),
                      this)
                );
              }),
              (w.prototype.end = function (e, t, r) {
                              ...
                              p(
                                ...
                                n.incomingStore.close(function (e) {
                                  n.outgoingStore.close(function (t) {
                                    if (
                                      (p("end :: closeStores: emitting end"),
                                      n.emit("end"),
                                      r)
                                    ) {
                                      let n = e || t;
                ...
                return (
                  p("end :: (%s)", this.options.clientId),
                  (null != e && "boolean" == typeof e) ||
                    ((r = t || v),
                    (t = e),
                    (e = !1),
                    "object" != typeof t &&
                      ((r = t), (t = null), "function" != typeof r && (r = v))),
              ...
              (w.prototype._reconnect = function () {
                p("_reconnect: emitting reconnect to client"),
                  this.emit("reconnect"),
                  p("_reconnect: calling _setupStream"),
                  this._setupStream();
              }),
              (w.prototype._setupReconnect = function () {
                ...
                e.options.reconnectPeriod > 0
                  ? (this.reconnecting ||
                      (p("_setupReconnect :: emit `offline` state"),
                      this.emit("offline"),
                      p("_setupReconnect :: set `reconnecting` to `true`"),
                      (this.reconnecting = !0)),
                    p(
                    ...
                    (e.reconnectTimer = setInterval(function () {
                      p("reconnectTimer :: reconnect triggered!"),
                        e._reconnect();
                    }, e.options.reconnectPeriod)))
                  : p("_setupReconnect :: doing nothing...");
              }),
              (w.prototype._clearReconnect = function () {
                p("_clearReconnect : clearing reconnect timer"),
                  this.reconnectTimer &&
              ...
              (w.prototype._cleanUp = function (e, t) {
                ...
                if (
                  ...
                  p("_cleanUp :: forced? %s", e),
                  e)
                )
                  0 === this.options.reconnectPeriod &&
                    this.options.clean &&
                    (r = this.outgoing) &&
                    (p("flush: queue exists? %b", !!r),
              ...
              (w.prototype._sendPacket = function (e, t, r) {
                if (
                  (p("_sendPacket :: (%s) ::  start", this.options.clientId),
                  (r = r || v),
                  !this.connected)
                )
                  return (
              ...
              (w.prototype._storePacket = function (e, t, r) {
                p("_storePacket :: packet: %o", e),
                  p("_storePacket :: cb? %s", !!t),
                  (r = r || v),
              ...
              (w.prototype._checkPing = function () {
                p("_checkPing :: checking ping..."),
                  this.pingResp
                    ...
                    : (p("_checkPing :: calling _cleanUp with force true"),
                      this._cleanUp(!0));
              }),
                  ...
                  switch ((p("_handleAck :: packet type", n), n)) {
                    ...
                    case "puback":
                      ...
                      a &&
                        a > 0 &&
                        16 !== a &&
                        (((t = new Error("Publish error: " + m[a])).code = a),
                        o(t, e)),
                    ...
                    case "pubrec":
                      ...
                      var c = e.reasonCode;
                      c && c > 0 && 16 !== c
                        ? (((t = new Error("Publish error: " + m[c])).code = c),
                          o(t, e))
                        : this._sendPacket(i);
                      break;
                    case "suback":
            ...
            t.exports = l
              ? function (e, t) {
                  ...
                  let h = (function (e, t) {
                    ...
                    d = (function (e, t, r) {
                      let n = new c({ objectModeMode: e.objectMode });
                      return (n._write = t), (n._flush = r), n;
                    })(
                      t,
                      function e(t, r, i) {
                        h.bufferedAmount > n && setTimeout(e, u, t, r, i),
                          l && "string" == typeof t && (t = s.from(t, "utf8"));
                        try {
                          h.send(t);
                        } catch (e) {
                          return i(e);
                  ...
                  function _(e) {
                    let t = e.data;
                    (t =
                      t instanceof ArrayBuffer ? s.from(t) : s.from(t, "utf8")),
                      d.push(t);
                  }
                  function v(e, t) {
                  ...
                  return (
                    h.readyState === h.OPEN
                      ? (r = d)
                      : ((r = r = o(void 0, void 0, t)),
                        t.objectMode || (r._writev = v),
                        g ? h.addEventListener("open", b) : (h.onopen = b)),
                    (r.socket = h),
                    g
              ...
              : function (e, t) {
                  ...
                  let s = (function (e, t, r) {
                      i("createWebSocket"),
                        i(
                          "protocol: " + r.protocolId + " " + r.protocolVersion
                        );
                      const o =
            ...
            t.exports = function (e, t) {
              ...
              return (
                ...
                n.onMessage(function (e) {
                  var t = e.data;
                  (t =
                    t instanceof ArrayBuffer ? r.from(t) : r.from(t, "utf8")),
                    i.push(t);
                }),
                n.onClose(function () {
                  o.end(), o.destroy();
        ...
        function (e, t, r) {
          ...
          i.inherits(s, n),
            ...
            (s.prototype.copy = function (e, t, r, n) {
              ...
              if (l <= this._bufs[c[0]].length - p)
                return a
                  ? this._bufs[c[0]].copy(e, t, p, p + l)
                  : this._bufs[c[0]].slice(p, p + l);
              for (
        ...
        function (e, t, r) {
          ...
          (n = function (e, t, r) {
            ...
            return (
              ...
              delete n.value,
              (n.get = function () {
                return !r.overwriteDefinition && p.call(this, e)
                  ? i
                  : ((t.value = l.call(
                      i,
            ...
            return (
              ...
              n(e)
                ? ((r = a.call(e, "c")),
                  ...
                  (c = a.call(e, "w")))
                : ((r = c = !0), (i = !1)),
              (l = { value: t, configurable: r, enumerable: i, writable: c }),
              u ? o(s(u), l) : l
            );
          }).gs = function (e, t, r) {
            var c, u, l, f;
        ...
        function (e, t, r) {
          ...
          t.exports = function (e) {
            ...
            for (
              r = i(o(this).length),
                l = arguments[1],
                t = l = isNaN(l) ? 0 : l >= 0 ? u(l) : i(this.length) - u(c(l));
              t < r;
              ++t
            )
            ...
            if (!f(e))
              if (void 0 !== (w = e[n])) {
                for (
                  ...
                  (S = k ? p.call(k, x, v.value, r) : v.value),
                    t ? ((h.value = S), d(b, r, h)) : (b[r] = S),
                    (v = _.next()),
                    ++r;
                m = r;
              } else if (l(e)) {
                for (m = e.length, t && (b = new t()), r = 0, g = 0; r < m; ++r)
                  (S = e[r]),
                    r + 1 < m &&
                      (y = S.charCodeAt(0)) >= 55296 &&
                      y <= 56319 &&
                      (S += e[++r]),
                    (S = k ? p.call(k, x, S, g) : S),
                    t ? ((h.value = S), d(b, g, h)) : (b[g] = S),
                    ++g;
                m = g;
              }
            if (void 0 === m)
              for (m = s(e.length), t && (b = new t(m)), r = 0; r < m; ++r)
                (S = k ? p.call(k, x, e[r], r) : e[r]),
                  t ? ((h.value = S), d(b, r, h)) : (b[r] = S);
          ...
          t.exports = function (e, t) {
            return function (r, u) {
              ...
              return (
                ...
                n(u),
                (l = a(r)),
                p && l.sort("function" == typeof p ? o.call(p, r) : void 0),
        ...
        function (e, t, r) {
          ...
          (t.exports = n = function () {
            ...
            if (!(this instanceof n))
              throw new TypeError("Constructor requires 'new'");
            return (
              (r = g && s && Map !== n ? s(new Map(), y(this)) : this),
              null != i && p(i),
              m(r, {
          ...
          (i = function (e) {
            ...
            (t.exports = n = function e(t) {
              ...
              return o
                ...
                : ((r = p(i.prototype)),
                  (t = void 0 === t ? "" : String(t)),
                  h(r, { __description__: s("", t), __name__: s("", u(t)) }));
            }),
            l(n),
            f(n),
            h(i.prototype, {
                ...
                t = Math.abs(t),
                  isNaN(t) || t === 1 / 0
                    ...
                    : ((s = Math.floor(Math.log(t) / Math.LN2)),
                      ...
                      (t += s + f >= 1 ? p / c : p * Math.pow(2, 1 - f)) * c >=
                        2 && (s++, (c /= 2)),
                      s + f >= l
                        ? ((a = 0), (s = l))
                        : s + f >= 1
          ...
          i(u, o),
            ...
            (u.prototype._parseConnect = function () {
              ...
              if (
                ...
                (u.will.payload = n),
                  c("_parseConnect: packet.will.paylaod: %s", u.will.payload);
              }
              if (s.username) {
            ...
            (u.prototype._parsePublish = function () {
              ...
              if (!(e.qos > 0) || this._parseMessageId()) {
                ...
                (e.payload = this._list.slice(this._pos, e.length)),
                  c("_parsePublish: payload from buffer list: %o", e.payload);
              }
            }),
            ...
            (u.prototype._parseUnsubscribe = function () {
              ...
              if (((e.unsubscriptions = []), this._parseMessageId())) {
                ...
                for (; this._pos < e.length; ) {
                  ...
                  if (null === (r = this._parseString()))
                    return this._emitError(new Error("Cannot parse topic"));
                  c("_parseUnsubscribe: push topic `%s` to unsubscriptions", r),
            ...
            (u.prototype._parseDisconnect = function () {
              var e = this.packet;
              if (
                (c("_parseDisconnect"), 5 === this.settings.protocolVersion)
              ) {
                e.reasonCode = this._parseByte();
                var t = this._parseProperties();
                Object.getOwnPropertyNames(t).length && (e.properties = t);
            ...
            (u.prototype._parseMessageId = function () {
              ...
              return (
                ...
                null === e.messageId
                  ...
                  : (c("_parseMessageId: packet.messageId %d", e.messageId), !0)
              );
            }),
      ...
      97: [
        function (e, t, r) {
            ...
            switch (
              ...
              case "connect":
                return (function (e, t, r) {
                  ...
                  if (c) {
                    ...
                    if (
                      ((b += i.byteLength(c.topic) + 2), (b += 2), c.payload)
                    ) {
                  ...
                  var S = 0;
                  (S |= null != p ? n.USERNAME_MASK : 0),
                    (S |= null != h ? n.PASSWORD_MASK : 0),
                    ...
                    5 === a && m.write();
                  E(t, f),
                    c && (5 === a && y.write(), w(t, c.topic), E(t, c.payload));
                  null != p && E(t, p);
                  null != h && E(t, h);
                  return !0;
                })(e, t);
              ...
              case "publish":
                return (function (e, t, r) {
                  ...
                  t.write(n.PUBLISH_HEADER[c][a.dup ? 1 : 0][l ? 1 : 0]),
                    v(t, b),
                    g(t, A(f)),
                    t.write(f),
                    c > 0 && g(t, h);
                ...
                return (function (e, t, r) {
                  ...
                  for (var k = !0, x = 0; x < l.length; x++) {
                    var E,
                      ...
                      P = C.rh;
                    w(t, O),
                      (E = n.SUBSCRIBE_OPTIONS_QOS[j]),
                      5 === o &&
                        ((E |= A ? n.SUBSCRIBE_OPTIONS_NL : 0),
                        (E |= T ? n.SUBSCRIBE_OPTIONS_RAP : 0),
                        (E |= P ? n.SUBSCRIBE_OPTIONS_RH[P] : 0)),
                      (k = t.write(i.from([E])));
                  }
                  return k;
                })(e, t, r);
          ...
          Object.defineProperty(m, "cacheNumbers", {
            ...
            set: function (e) {
              e
                ? ((l && 0 !== Object.keys(l).length) || (b = !0), (g = k))
                : ((b = !1), (g = x));
            },
          });
          var _ = {};
            ...
            function o(t, r) {
              ...
              switch (n.propertiesTypes[t]) {
                case "byte":
                  if ("boolean" != typeof r)
                    return (
                      e.emit("error", new Error("Invalid " + t + ": " + r)), !1
                    );
                  o += 2;
                  break;
                case "int8":
            ...
            !(function (n) {
                  ...
                  for (
                    ...
                    i >= v && E("invalid-input"),
                      ((c =
                        ...
                        E("overflow"),
                      (w += c * s),
                      !(c < (h = a <= x ? f : a >= x + p ? p : a - x));
                    a += l
                  )
                    s > k(u / (d = l - h)) && E("overflow"), (s *= d);
                  (x = T(w - o, (t = _.length + 1), 0 == o)),
                    k(w / t) > u - S && E("overflow"),
                    (S += k(w / t)),
                    (w %= t),
                    _.splice(w++, 0, S);
                }
              ...
              function M(e) {
                ...
                for (
                  ...
                  (y = e[s]) < 128 && I.push(x(y));
                for (n = i = I.length, i && I.push(m); n < _; ) {
                  for (a = u, s = 0; s < _; ++s)
                    (y = e[s]) >= t && y < a && (a = y);
                  for (
                    a - t > k((u - r) / (v = n + 1)) && E("overflow"),
                      r += (a - t) * v,
                      t = a,
                      s = 0;
                    s < _;
            ...
            (_.prototype.read = function (e) {
              ...
              if (
                ...
                return (
                  ...
                  0 === t.length && t.ended ? P(this) : x(this),
                  null
                );
              ...
              (_.prototype.on = function (e, t) {
                ...
                if ("data" === e)
                  ...
                  n.endEmitted ||
                    ...
                    (n.emittedReadable = !1),
                    n.reading ? n.length && x(this) : i.nextTick(O, this));
                }
                return r;
              }),
              ...
              if (e._writev && r && r.next) {
                ...
                for (; r; ) {
                  var u = r.chunk,
                    ...
                    f = r.callback;
                  if (
                    (_(e, t, !1, t.objectMode ? 1 : u.length, u, l, f),
                    (r = r.next),
            ...
            u.inherits(y, f),
                ...
                ? ((d = Function.prototype[Symbol.hasInstance]),
                  Object.defineProperty(y, Symbol.hasInstance, {
                    value: function (e) {
                      return (
                        !!d.call(this, e) ||
                        (this === y && e && e._writableState instanceof m)
                      );
                    },
                  }))
                : (d = function (e) {
              ...
              (y.prototype.write = function (e, t, r) {
                var n,
                  ...
                  s = !1,
                  a =
                    !i.objectMode && ((n = e), p.isBuffer(n) || n instanceof h);
                return (
                  a &&
                    !p.isBuffer(e) &&
                    (e = (function (e) {
        ...
        function (e, t, r) {
          ...
          (o.prototype.parse = function (e, t, r) {
            ...
            if (!b[w] && (k || (w && !m[w]))) {
              ...
              if (!j)
                for (
                  var A = this.hostname.split(/\./), T = ((C = 0), A.length);
                  C < T;
                  C++
                ) {
                  var P = A[C];
            ...
            (o.prototype.resolveObject = function (e) {
              ...
              for (
                ...
                "." === (E = k[O])
                  ...
                  ? (k.splice(O, 1), C++)
                  : C && (k.splice(O, 1), C--);
              if (!w && !S) for (; C--; C) k.unshift("..");
              !w ||
                "" === k[0] ||
                (k[0] && "/" === k[0].charAt(0)) ||
                k.unshift(""),
                I && "/" !== k.join("/").substr(-1) && k.push("");
              var j,
